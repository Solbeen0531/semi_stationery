...
CREATE TABLE "GOODS" (
	...
	"GOTY"	VARCHAR2(20)		NOT NULL,
	"GOPRICE"	NUMBER		NOT NULL,
	"GOIMG"	VARCHAR2(100)		NULL
);

COMMENT ON COLUMN "GOODS"."GOTY" IS '전체 메뉴 GOTY-A ALLMENU | 생활용품 GOTY-S LIFESTYLE | 편지지 GOTY-L LETTERS |';
...
COMMENT ON COLUMN "GOTYPE"."GOTY" IS '전체 메뉴 GOTY-A ALLMENU | 생활용품 GOTY-S LIFESTYLE | 편지지 GOTY-L LETTERS |';
